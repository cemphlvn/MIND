...
Given MIND's nature as infrastructure, we additionally value:

* **Technical honesty** — Do not overstate capabilities or make unfounded claims
* **Epistemic humility** — Acknowledge uncertainty and limitations
* **Long-term thinking** — Prioritize durability over short-term gains
* **Simplicity** — Resist complexity that doesn't serve core goals
